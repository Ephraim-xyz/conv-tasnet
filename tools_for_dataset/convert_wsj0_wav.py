...
root_dir = "C:\\Users\\Aliphraim\\Desktop\\dataset\\csr_1"
...
my_path = "C:\\Users\\Aliphraim\\Desktop\\dataset\\converte_wave\\wsj0"
        ...
        if sub_data_dir[0][0] == 's':
            ...
            for list_spk in os.listdir(datatype_dir):
                ...
                for wv_file in os.listdir(spk_dir_abs):
                    ...
                    # rif == wav
                    cmd = "C:\\Users\\Aliphraim\\Desktop\\dataset\\converte_wave\\sph2pipe -f wav " + speech_dir + " " + target_dir
                    os.system(cmd)
