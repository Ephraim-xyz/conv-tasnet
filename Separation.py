'''
Author: your name
Date: 2019-11-27 12:01:49
LastEditTime: 2020-12-25 11:21:29
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /Conv-TasNet/Separation.py
'''
import os
import torch
import sys
    ...
    def inference(self, file_path):
        with torch.no_grad():
            for key, egs in tqdm.tqdm(self.mix):
                ...
                norm = torch.norm(egs,float('inf')).cpu()
                if len(self.gpuid) != 0:
                    ests=self.net(egs)
...
def main():
    ...
    parser.add_argument(
        '-yaml', type=str, default='/home/likai/data1/Conv-TasNet/options/train/train.yml', help='Path to yaml file.')
    parser.add_argument(
        '-model', type=str, default='/home/likai/data1/Conv-TasNet/Conv-TasNet/best_1.pt', help="Path to model file.")
    parser.add_argument(
